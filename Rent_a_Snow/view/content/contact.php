            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div id="divLogo" class="pull-left">
                        <a href="../gabarit.php" id="divSiteTitle">Your Name</a><br />
                        <a href="../gabarit.php" id="divTagLine">Your Tag Line Here</a>
                    </div>
                    ...
                    <div class="navbar">
                        ...
                        NAVIGATION <span class="icon-chevron-down icon-white"></span>
                            ...
                            <li><a href="../gabarit.php">Home</a></li>
    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="../gabarit.php">Home</a> &nbsp;/&nbsp; <span>Contact</span>
            </div>
