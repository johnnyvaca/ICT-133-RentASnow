        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div id="divLogo" class="pull-left">
                    <a href="gabarit.php" id="divSiteTitle">Rent A Snow</a><br/>
                    <a href="gabarit.php" id="divTagLine">La glisse à moindre coût</a>
                </div>
                    ...
                    <div class="navbar">
                        ...
                        <div class="nav-collapse collapse">
                            <ul class="nav nav-pills ddmenu">
                                <li class="active"><a href="index.php?action=home">Acceuil</a></li>
